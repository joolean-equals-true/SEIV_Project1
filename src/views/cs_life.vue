...
<template>
    ...
    <h1 id = "main-cs-life-header" class = "center-text">Life of a CS major</h1>
    <div id ="main-cs-life-div"class = "flex-row">
      <div id ="cs-life-div1" class = "flex-column">
        <h2 id = "h2-cs-life" class = "accent-color-text">Casual</h2>
      <LargeCard
      :msg="remote_msg"
      :img="remote_img"
      />
